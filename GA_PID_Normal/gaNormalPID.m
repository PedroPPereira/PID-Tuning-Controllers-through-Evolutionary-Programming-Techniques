...
figure(4)
subplot(2,1,1), plot(t, y, '-', t, ref, '-. k'), grid on, axis([0 60 0 5]),
title('Resposta em anel fechado do PID clássico com AG'), legend('y(k)','ref(k)'), 
...
xlabel('Tempo [s]','Interpreter','latex'), ylabel({'u(k) [V]'},'Interpreter','latex');
%error results
